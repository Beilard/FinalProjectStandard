...
public class RegistrationValidatorTest {
    ...
    @Test
    public void validate_normalBehaviour() {
        registrationValidator.validate(getUser(EMAIL, PASSWORD));
    }

    @Test(expected = EntityNotFoundException.class)
    public void validate_nullPassed() {
        registrationValidator.validate(null);
    }

    @Test(expected = InvalidCredentialsException.class)
    public void validate_shouldThrowDueToWrongEmail() {
        registrationValidator.validate(getUser("123", PASSWORD));
    }

    @Test(expected = InvalidCredentialsException.class)
    public void validate_shouldThrowDueToWrongPassword() {
